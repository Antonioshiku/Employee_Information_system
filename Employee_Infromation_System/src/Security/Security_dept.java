...
public class Security_dept extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Security_dept frame = new Security_dept();
	...
	public Security_dept() {
		...
		JLabel lblAdmin = new JLabel("Security Dept");
		lblAdmin.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdmin.setBounds(21, 102, 91, 28);
