...
public class management_dept extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					management_dept frame = new management_dept();
	...
	public management_dept() {
		...
		JLabel lblAdmin = new JLabel("Management Dept");
		lblAdmin.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdmin.setBounds(10, 101, 124, 28);
