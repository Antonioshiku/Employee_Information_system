...
public class create_emp_dept extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					create_emp_dept frame = new create_emp_dept(null,null,null,null);
	 ...
	 * Create the frame.
	 */
	public create_emp_dept(String emp,String dept,String email,String Type) {
		...
		lblAdmin.setFont(new Font("Modern No. 20", Font.BOLD, 15));
		...
		lblaphonen.setBounds(0, 126, 145, 23);
		...
		button_2_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				try {
					new View_Table(emp,dept,email,Type).setVisible(true);
