...
public class other_dept_emp_info extends JFrame {
	...
	public other_dept_emp_info(String dept) throws SQLException {
		...
		cboType.setBounds(10, 269, 328, 28);
		panel_1.add(cboType);
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (ch == true) {
					...
					q.setQF_id(QF_id);
					q.setEmp_id(emp_id);
					q.setDept_id(Integer.parseInt(dept));
					...
					r.setEmp_id(Emp_id);
					r.setDept_id(Integer.parseInt(dept));
					...
					if (choice == JOptionPane.YES_OPTION)
						try {
							new ApplicationDAO().addEmployee_QFInfo(q);
							new ApplicationDAO().addEmployee_RoleInfo(r);
							new ApplicationDAO().addEmployee_Work_expInfo(w);
