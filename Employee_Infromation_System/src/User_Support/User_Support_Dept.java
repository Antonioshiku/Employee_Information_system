...
public class User_Support_Dept extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					User_Support_Dept frame = new User_Support_Dept();
	...
	public User_Support_Dept() {
		...
		JLabel lblAdmin = new JLabel("User Support Dept");
		lblAdmin.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdmin.setBounds(0, 101, 135, 28);
		panel_1.add(lblAdmin);
		lblAdmin.setFont(new Font("Modern No. 20", Font.BOLD, 14));
		
		JLabel lblaphonen = new JLabel("@deptHead");
