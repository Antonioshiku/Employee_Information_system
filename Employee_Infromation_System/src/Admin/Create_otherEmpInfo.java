...
public class Create_otherEmpInfo extends JFrame {
	...
	private JComboBox cboType, txtdept, txtdept_id;
	 ...
	 * @throws SQLException
	 */
	public Create_otherEmpInfo() throws SQLException {
		setIconImage(
		...
		label_7.setBounds(10, 111, 245, 14);
		panel_1.add(label_7);

		txtemp = new JTextField();
		txtemp.setColumns(10);
		txtemp.setBounds(10, 135, 328, 28);
		panel_1.add(txtemp);
		...
		lblDepartmentId.setBounds(10, 161, 245, 14);
		...
		txtqf_id.setBounds(10, 84, 328, 28);
		...
		lblQualificationId.setBounds(10, 60, 245, 14);
		...
		txtdept = new JComboBox(new AdminDAO().showEmpId().toArray());
		txtdept.setFont(new Font("MS Reference Sans Serif", Font.BOLD, 11));
		txtdept.setBounds(10, 185, 328, 26);
		panel_1.add(txtdept);
		...
		txtdept_id = new JComboBox(new AdminDAO().showEmpId().toArray());
		txtdept_id.setFont(new Font("MS Reference Sans Serif", Font.BOLD, 11));
		txtdept_id.setBounds(10, 185, 328, 26);
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (ch == true) {
					...
					int dept_id = Integer.parseInt(txtdept.getSelectedItem().toString());
	...
	public boolean inputCheck() {
		...
		if (txtqf_id.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Qualification ID is required data", "Input Missing Error",
					JOptionPane.ERROR_MESSAGE);
			txtqf_id.requestFocus();
		} else {
			if (txtemp.getText().isEmpty()) {
				JOptionPane.showMessageDialog(null, "Employee ID is required data", "Input Mission Error",
						JOptionPane.ERROR_MESSAGE);
				txtemp.requestFocus();
			} else {
				if (cboType.getSelectedIndex() == 0) {
					JOptionPane.showMessageDialog(null, "Type is required data", "Input Missing Error",
							JOptionPane.ERROR_MESSAGE);
				}

				else {
					if (txtdegree.getText().isEmpty()) {
						JOptionPane.showMessageDialog(null, "Degree Certificate is required data",
								"Input Missing Error", JOptionPane.ERROR_MESSAGE);
						txtdegree.requestFocus();
					} else {
						if (txtfname.getText().isEmpty()) {
							JOptionPane.showMessageDialog(null, "Field_Name is required data", "Input Missing Error",
									JOptionPane.ERROR_MESSAGE);
							txtfname.requestFocus();
						} else {
							if (txtoname.getText().isEmpty()) {
								JOptionPane.showMessageDialog(null, "Org_Name is required data", "Input Missing Error",
										JOptionPane.ERROR_MESSAGE);
								txtoname.requestFocus();
							} else {
								if (dcFrom_date.getDate() == null) {
									JOptionPane.showMessageDialog(null, "From Date is required data",
											"Input Mission Error", JOptionPane.ERROR_MESSAGE);
								} else {
									if (dcEnd_date.getDate() == null) {
										JOptionPane.showMessageDialog(null, "End Date is required data",
												"Input Mission Error", JOptionPane.ERROR_MESSAGE);
									}
								}
							}
		...
		if (txtrole_id.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Role ID is required data", "Input Missing Error",
					JOptionPane.ERROR_MESSAGE);
			txtrole_id.requestFocus();
		} else {
			if (txtemp_id.getText().isEmpty()) {
				JOptionPane.showMessageDialog(null, "Employee ID is required data", "Input Missing Error",
						JOptionPane.ERROR_MESSAGE);
				txtemp_id.requestFocus();
			} else {
				if (txtp.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null, "Position is required data", "Input Missing Error",
							JOptionPane.ERROR_MESSAGE);
					txtp.requestFocus();
				} else {
					if (txts.getText().isEmpty()) {
						JOptionPane.showMessageDialog(null, "Salary is required data", "Input Missing Error",
								JOptionPane.ERROR_MESSAGE);
						txts.requestFocus();
					} else {
						if (txtstatus.getText().isEmpty()) {
							JOptionPane.showMessageDialog(null, "Status is required data", "Input Missing Error",
									JOptionPane.ERROR_MESSAGE);
							txtstatus.requestFocus();
						} else {
							if (dcfrom_date.getDate() == null) {
								JOptionPane.showMessageDialog(null, "From Date is required data", "Input Mission Error",
										JOptionPane.ERROR_MESSAGE);
							} else {
								if (dcto_date.getDate() == null) {
									JOptionPane.showMessageDialog(null, "To Date is required data",
											"Input Mission Error", JOptionPane.ERROR_MESSAGE);
								}
							}
						}
		...
		if (txtW_id.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "Work ID is required data", "Input Missing Error",
					JOptionPane.ERROR_MESSAGE);
			...
			if (txte_id.getText().isEmpty()) {
				...
				if (txtC.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null, "Company name is required data", "Input Missing Error",
							JOptionPane.ERROR_MESSAGE);
					txtC.requestFocus();
				} else {
					if (txtP.getText().isEmpty()) {
						...
						if (txtW_exp.getText().isEmpty()) {
							JOptionPane.showMessageDialog(null, "Working experience is required data",
									"Input Missing Error", JOptionPane.ERROR_MESSAGE);
