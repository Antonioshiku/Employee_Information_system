...
public class Programming_dept extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Programming_dept frame = new Programming_dept();
	...
	public Programming_dept() {
		...
		JLabel lblAdmin = new JLabel("Programming Dept");
		lblAdmin.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdmin.setBounds(0, 102, 135, 28);
